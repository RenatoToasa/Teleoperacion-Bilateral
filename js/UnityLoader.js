...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'V30.data';
    var REMOTE_PACKAGE_BASE = 'V30.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 18818227;
      var PACKAGE_UUID = '4b6b386d-36c5-47cf-b82d-af6a924ea287';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 15873292, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(15873292, 15873313, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(15873313, 17293909, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(17293909, 18790601, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(18790601, 18818227, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_V30.data');

    };
    Module['addRunDependency']('datafile_V30.data');
